...
function [W,V,b,c] = sDANN(X, Y, X_adapt, learning_rate, hidden_layer_size,...
    maxiter, lambda_adapt, adversarial_representation, seed)
...
for t = 1:maxiter
    for i = 1:nb_examples
        ...
        y_hot(y_t==Ylabel) = 1; %one-hot vector
